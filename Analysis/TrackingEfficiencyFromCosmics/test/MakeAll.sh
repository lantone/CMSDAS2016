...
SIMDIR="$LOCALRT/src/Analysis/TrackingEfficiencyFromCosmics/test/efficiency_data"
DATADIR="$LOCALRT/src/Analysis/TrackingEfficiencyFromCosmics/test/efficiency_sim"
